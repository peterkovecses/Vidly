...
namespace Vidly.Migrations
{
    ...
    [Migration("20220518092413_AddBooks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vidly.Models.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            Author = "A.F. Steadman",
                            Description = "Soar into a breathtaking world of heroes and unicorns as you’ve never seen them before in this fantastical middle grade debut perfect for fans of the Percy Jackson and Eragon series!",
                        ...
                        new
                        {
                            ...
                            Description = "Meet Judith: a seventy-seven-year-old whiskey drinking, crossword puzzle author living her best life in a dilapidated mansion on the outskirts of Marlow.",
                        ...
                        new
                        {
                            Id = 4,
                            Author = "Mike Chen",
                            Description = "Obi-Wan Kenobi and Anakin Skywalker must stem the tide of the raging Clone Wars and forge a new bond as Jedi Knights in a high-stakes adventure set just after the events of Star Wars: Attack of the Clones.",
            ...
            modelBuilder.Entity("Vidly.Models.MusicAlbum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Vidly.Models.MusicAlbum", b =>
                {
                    b.HasOne("Vidly.Models.MusicGenre", "Genre")
                        .WithMany()
                        .HasForeignKey("GenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
